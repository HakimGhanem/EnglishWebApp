...
<form method="post" action="QuizzIverbsC.php">
   <label>
    Wesh mon gars , tu t'appelles <select name="nom">
        <option value="Ahmed 1">Ahmed</option>
        <option value="Mamadou 2" selected="selected">Mamadou</option>
        <option value="Banania 3">Banania</option>
    </select> ?<br />
    </label>
